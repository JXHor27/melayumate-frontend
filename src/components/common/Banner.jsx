...
function Banner({header, title, onOpen, handleSidebarToggle}){
    ...
    return(
        <div className="bg-slate-300/60 text-gray-900 dark:bg-zinc-700 dark:text-white flex items-center rounded-md p-4 mb-8 shadow">
            ...
            <p className='ml-auto'>MelayuMate <span className='text-zinc-600 dark:text-zinc-400'>{'>'} {title}</span></p>
        </div> 
    )
}
