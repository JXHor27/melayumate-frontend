...
function ChatPanel({ messages, onSendMessage, onClose }) {
  ...
  useEffect(() => {
    const updateDate = () => {
      ...
      setCurrentDate(`${year}-${month}-${paddedDay}`);
    };
  ...
  return (
    <div ref={panelRef} className="fixed bottom-20 right-4 w-65 sm:w-85 md:w-96 h-[60vh] max-h-[600px] bg-gray-800 border border-gray-700 rounded-lg shadow-2xl flex flex-col z-50">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-gray-700 flex-shrink-0">
        <h3 className="font-bold text-lg text-white">MelayuMate Chat</h3>
