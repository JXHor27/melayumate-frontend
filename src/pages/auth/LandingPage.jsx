...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-start px-4">
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <motion.div
            ...
            className="relative bg-black text-white rounded-xl px-4 py-2 shadow-md"
          >
          ...
          <div className="flex justify-between mb-4">
            <button
              ...
              className={`w-1/2 py-2 font-semibold ${
                isLogin ? "bg-yellow-400 text-black" : "bg-gray-600 hover:bg-gray-400 text-black cursor-pointer"
              } rounded-l-xl`}
            >
              Login
            </button>
